...
namespace CaptionScribe
{
    public partial class App : Application, INotificationService
    {
        ...
        private void OnStartup(object sender, StartupEventArgs e)
        {
            ...
            _log.Info("CaptionScribe starting.");
            ...
            WarnIfOcrUnavailable();

            ManageAutoSaveCacheOnStartup(_dialogs);
        }
        ...
        private void WarnIfOcrUnavailable()
        {
        ...
        private void ManageAutoSaveCacheOnStartup(WpfDialogService dialogs)
        {
            try
            {
        ...
        // ---- global exception handlers (log everything; keep the app alive where we safely can) ----
